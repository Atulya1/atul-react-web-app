    ...
    return(
        <>
            <div className="border rounded px-0 py-2">
                ...
                <div>
                    <div className="position-relative">
                        <div className="row wd-banner position-relative d-inline ms-0">
                            <img src={profile.bannerPicture} alt="img" className="w-100 px-0 mx-0 border-0"></img>
                        ...
                        <div className="row img-wrapper card-img-overlay top-50 h-100 ms-3 mb-4 position-absolute">
                            <div className="col-2 card-img-overlay mt-5 img-fluid">
                                ...
                                <img src={profile.profilePicture} alt="avatar" className="h-50 rounded-circle mx-3 my-5 top-50"></img>
                ...
                <br/>
                <div className="row d-inline px-3 mt-4">
                    <form className="mt-5">
                        ...
                        <div className="mt-4 text-bg-light">
                            <text className="m-lg-2 text-black">Switch To Professional </text>
                            <i className="fa-solid fa-chevron-right float-lg-end mt-1"></i>
                        </div>
                    </form>
                </div>
            </div>
