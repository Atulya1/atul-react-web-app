        ...
        <li className="list-group-item">
            <div className="row">
                ...
                <div className="col-10">
                    <div className="fw-bold">{homeExperience.name} </div>
                    <Box
                        sx={{
                            '& > legend': { mt: 2 },
                        }}
                    ...
                    <div>
                        <text className="Heading text-black fw-bold">{homeExperience.travel_place}</text>
                        <br/>
                        <text className="Heading text-black">{homeExperience.travel_date}</text>
                    </div>
                    <div>
                        <text className="Heading text-black fw-bold">{homeExperience.experience.heading}</text>
                        <br/>
